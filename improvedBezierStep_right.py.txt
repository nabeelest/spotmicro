...
if __name__ == "__main__":
    try:
        ...
        points = [(-221, 177), (-154, 169), (-124, 10), (-243, 20)]
        ...
        for t in range(0, 101, 1):
            ...
            if servo1_angle is not None and servo2_angle is not None:
                ...
                active_servo1.set_pulse_width_range(min_pulse=400, max_pulse=2450)
                active_servo2.set_pulse_width_range(min_pulse=850, max_pulse=3000)
                active_servo3.set_pulse_width_range(min_pulse=400, max_pulse=2450)
                active_servo4.set_pulse_width_range(min_pulse=850, max_pulse=3000)
