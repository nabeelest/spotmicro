...
if __name__ == "__main__":
    try:
        # Example end effector coordinates
        end_effector_x = 150
        end_effector_y = 150

        # Calculate servo angles using inverse kinematics
        servo1_angle, servo2_angle = inverse_kinematics(end_effector_x, end_effector_y)
        ...
        if servo1_angle is not None and servo2_angle is not None:
            ...
            active_servo2.set_pulse_width_range(min_pulse=500, max_pulse=2500)
